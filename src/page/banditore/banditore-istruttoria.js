...
export class BanditoreIstruttoria extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      data: [{
        NomeForn:  this.props.location.state.rowSel.Nome,
        IVAForn: this.props.location.state.rowSel.IVAForn,
        //FGiurid: this.props.location.state.rowSel.FGiurid,
        //PEC: this.props.location.state.rowSel.PEC,
        //SitoWeb: this.props.location.state.rowSel.SitoWeb,
      }],
  ...
  getDataForn() {
    let self = this;
    axios.post('/api/getFornIstr', {
      ID: this.props.location.state.rowSel[0][0].ID,
    }).then( (response) => {
  ...
  getProposta(){
    ...
    axios.post('/api/getProposta', {
      IDForn: this.props.location.state.rowSel[0][0].ID,
      IDBando: this.props.location.state.bando.ID,
    })
    .then( (response) => {
      //const res = response.clone();
